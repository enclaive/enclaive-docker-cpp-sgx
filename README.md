...
<div align="center">
  ...
  <h2 align="center">Cpp-SGX: Execute C++ applications in the safest Confidential Compute runtime</h2>

  <p align="center">
    <h3>packed by <a href="https://enclaive.io">enclaive</a></h3>
    </br>
    #intelsgx #confidentialcompute #cpp
    <br />
    <a href="#contributing">Contribute</a>
    ·
    <a href="https://github.com/enclaive/enclaive-docker-cpp-sgx/issues">Report Bug</a>
    ·
...
[Overview of C++](https://isocpp.org/)
...
<!-- WHY -->
## Why use Cpp-SGX (instead of "vanilla" Cpp) images?
Following benefits come for free with Cpp-SGX :

* Protect C++ code, files, applications, services, APIs, (AI) models against intelectual property theft/violation irrespectively where the application runs thanks to full fledge memory container encryption and integrity protection at runtime
...
* Build and deploy C++ application as usual while inheriting literally for free security and privacy through containerization including
...
```console
docker pull enclaive/cpp-sgx:latest
```
...
```console
docker pull enclaive/cpp-sgx:[TAG]
```
...
```console
docker build -t enclaive/cpp-sgx:latest 'https://github.com/enclaive/enclaive-docker-cpp-sgx.git#master'
```
